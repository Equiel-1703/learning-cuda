...
__constant__ unsigned char spheresDevice[NUM_SPHERES * sizeof(Sphere)];
...
int main(int argc, char const *argv[])
{
    ...
    CHECK_ERROR(cudaMemcpyToSymbol(spheresDevice, spheres,
    ...
    renderKernel<<<grid, threads>>>(bitmapDevice, (Sphere *)spheresDevice);
